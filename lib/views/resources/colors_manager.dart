...
// new colors
  ...
  static Color lightPrimaryColor = const Color(0xccd17d11); // color with 80% opacity
  static Color grey1Color = const Color(0xff707070);
  static Color grey2Color = const Color(0xff797979);
